...
D20 = {
    ...
    FUTURE: {
        ...
        MUTATIONS: {
            ...
            BLOOD_HUNGER: f'#blood-hunger',
            BRITTLE_BONES: f'#brittle-bones',
            CLAWS: f'#claws',
            COMBAT_FEAR: f'#combat-fear',
            CYBERNETIC_DEPENDENCY: f'#cybernetic-dependency',
            DARKVISION: f'#darkvision',
            ECHOLOCATOR: f'#echolocator',
            ELASTICITY: f'#elasticity',
            ENERGY_ABSORPTION: f'#energy-absorption',
            ENERGY_DIFFUSION: f'#energy-diffusion',
            ENLARGED_FORM: f'#enlarged-form',
            EXOSKELETON: f'#exoskeleton',
            EXTRA_ARMS: f'#extra-arms',
            EXTRA_DIGITS: f'#extra-digits',
            FANGS: f'#fangs',
            FESTERING_SORES: f'#festering-sores',
            FINS: f'#fins',
            FORCE_BARRIER: f'#force-barrier',
            FORKED_TONGUE: f'#forked-tongue',
            FRAILTY: f'#frailty',
            GAZING_EYE: f'#gazing-eye',
            GILLS: f'#gills',
            GREAT_HORNS: f'#great-horns',
            HEAT_COLD_SUSCEPTIBILITY: f'#heatcold-susceptibility',
            HORNS: f'#horns',
            HYPERSENSITIVITY: f'#hypersensitivity',
            LEAPER: f'#leaper',
            LETHARGY: f'#lethargy',
            LIGHT_SENSITIVITY: f'#light-sensitivity',
            LOST_ARM: f'#lost-arm',
            MINDSLAVE: f'#mindslave',
            NEUTRAD_DEPENDENCY: f'#neutrad-dependency',
            PHEROMONE_ATTRACTION: f'#pheromone-attraction',
            PHEROMONE_REPULSION: f'#pheromone-repulsion',
            POISONOUS_BLOOD: f'#poisonous-blood',
            PREHENSILE_TAIL: f'#prehensile-tail',
            PRICKLY_PEAR: f'#prickly-pear',
            RADIOACTIVE: f'#radioactive',
            RAPID_AGING: f'#rapid-aging',
            REDUCED_SPEED: f'#reduced-speed',
            SCALY_ARMOR: f'#scaly-armor',
            SCALY_SKIN: f'#scaly-skin',
            SCENT: f'#scent',
            SECOND_WIND: f'#second-wind',
            SKELETAL_REINFORCEMENT: f'#skeletal-reinforcement',
            SMOKESCREEN: f'#smokescreen',
            STINGER: f'#stinger',
            TAIL: f'#tail',
            TELEKINETIC_MIND: f'#telekinetic-mind',
            TELEPATHY: f'#telepathy',
            TENTACLE: f'#tentacle',
            THICK_FUR_COAT: f'#thick-fur-coat',
            THIN_FUR_COAT: f'#thin-fur-coat',
            THIN_SKIN: f'#thin-skin',
            ULTRA_IMMUNE_SYSTEM: f'#ultra-immune-system',
            ULTRAVIOLET_ALLERGY: f'#ultraviolet-allergy',
            UNNATURAL_EYES: f'#unnatural-eyes',
            UNNATURAL_HAIR: f'#unnatural-hair',
            UNNATURAL_SKIN: f'#unnatural-skin',
            UNNATURAL_VOICE: f'#unnatural-voice',
            VENOMOUS_BITE: f'#venomous-bite',
            VEXING_VOICE: f'#vexing-voice',
            WALL_CRAWLER: f'#wall-crawler',
            WEAK_IMMUNE_SYSTEM: f'#weak-immune-system',
